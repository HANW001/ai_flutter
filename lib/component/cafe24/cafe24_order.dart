...
class Cafe24OrderPage extends StatefulWidget {
  const Cafe24OrderPage({super.key});

  @override
  State<Cafe24OrderPage> createState() => _Cafe24OrderPageState();
}

class _Cafe24OrderPageState extends State<Cafe24OrderPage> {
  @override
  Widget build(BuildContext context) {
    final authState = Provider.of<Cafe24AuthState>(context, listen: false);
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('카페24 데이터 불러오기'),
      ),
      body: Column(
        children: [
